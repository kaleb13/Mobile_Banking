...
import '../lib/models/cash_transaction.dart';
import '../lib/domain/usecases/analytics/get_balance_history_usecase.dart';
...
void main() {
  ...
  final transactions = [
    // Aug 4 (13 days ago)
    AppTransaction(name: 'Dashen Bank', sender: 'Nahom', amount: 7000, type: 'income', date: DateTime(2026, 8, 4), category: 'Auto', rawMessage: '', isAutoDetected: true, totalBalance: 39226.94),
    // Aug 13
  ...
  final cashTransactions = [
    CashTransaction(id: 1, amount: 600, type: 'addition', date: DateTime(2026, 8, 1)),
  ];
  ...
  for (int i = 0; i < result.spots.length; i++) {
    ...
    print('Spot $i (${pt.date.month}/${pt.date.day}): totalBalance = ${spot.y.toStringAsFixed(2)}');
  }
